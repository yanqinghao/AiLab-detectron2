...
do
    ...
    docker build --build-arg NAME_SPACE=${i} -t registry-vpc.cn-shanghai.aliyuncs.com/${i}/detectron2-stream-gpu:$1 -f docker/stream_detectron2_gpu/Dockerfile .
    ...
    docker build --build-arg NAME_SPACE=${i} -t registry-vpc.cn-shanghai.aliyuncs.com/${i}/detectron2-stream:$1 -f docker/stream_detectron2/Dockerfile .
